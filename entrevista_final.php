...
<html lang="en">
<head>
	<title>ENSEÑÁ POR ARGENTINA: ENTREVISTAS FINALES.</title>
...
<div class="container">
	<div class="row">
		<div class="col-lg-12 col-md-12"><h2>ENSEÑÁ POR ARGENTINA: ENTREVISTAS FINALES</h2></div>
	</div>
	<div class="row">
		<div class="col-lg-12 col-md-12"><h4>Completando tus datos en el siguiente formulario quedarás registrado para una <span class="etapa">ENTREVISTA FINAL</span>.<br>
	...
	<div class="row busqueda">
		<div class="col-lg-12 col-md-12"><span class="indicacion">&nbsp;2&nbsp;</span>&nbsp;Seleccione un turno de la siguiente lista. Al hacerlo habrá seleccionado un lugar, fecha y rango horario para la entrevista final.</div>
	</div>
	<br/>	
	...
	{
		$individuales = $model->getVacantes("Entrevista Final", $_POST["email"]);
	}
