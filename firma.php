...
<html lang="en">
<head>
	<title>ENSEÑÁ POR ARGENTINA: FIRMA DE CONTRATO.</title>
...
<div class="container">
	<div class="row">
		<div class="col-lg-12 col-md-12"><h2>ENSEÑÁ POR ARGENTINA: FIRMA DE CONTRATO</h2></div>
	</div>
	<div class="row">
		<div class="col-lg-12 col-md-12"><h4>Completando tus datos en el siguiente formulario quedarás registrado para una <span class="etapa">FIRMA DE CONTRATO</span>.<br>
	...
	<div class="row busqueda">
		<div class="col-lg-12 col-md-12"><span class="indicacion">&nbsp;2&nbsp;</span>&nbsp;Seleccione un turno de la siguiente lista. Al hacerlo habrá seleccionado un lugar, fecha y rango horario para la firma de contrato.</div>
	</div>
	<br/>	
	...
	{
		$individuales = $model->getVacantes("Firma de Contrato", $_POST["email"]);
	}
	...
	foreach ($individuales as $key => $value) {
		...
		if($libre){
			echo '<input class="seleccionador" type="checkbox" id="'.$id.'">';
		}
		else{
	...
	if (count($individuales)==0) {
		echo '<div class="row">
				<div class="col-lg-12 col-md-12 vacia busqueda">No se encontraron opciones para su email. Por favor, pongase en contacto con quieroserpexa@ensenaporargentina.org</div>';
	}
